...
public extension NavigationViewItem {
    ...
    static func build(iconGlyph: String, label: String, url: String, actionGlyph: String? = nil, actionTooltip: String? = nil, actionHandler: ((Optional<Any>, Optional<RoutedEventArgs>) throws -> ())? = nil) -> NavigationViewItem {
